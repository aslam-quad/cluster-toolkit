...
class GitHubClient:
    def __init__(self):
        ...
        self.repo_name = os.getenv("GITHUB_REPO", "example-owner/example_repository")
    ...
    def create_rc_and_version_branches(self):
        ...
        try:
            ...
            if result.returncode != 0:
             ...
             # A fallback name in case the script doesn't print it
            rc_branch_detected = "release-candidate"

            # 2. Extract the actual branch name (RC_BRANCH_NAME:...) printed by the bash script
            for line in result.stdout.splitlines() + result.stderr.splitlines():
                if "RC_BRANCH_NAME:" in line:
                    rc_branch_detected = line.split("RC_BRANCH_NAME:")[1].strip()
